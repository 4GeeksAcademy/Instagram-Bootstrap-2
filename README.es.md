...
- También puedes crear archivos CSS e importarlos en tu página web utilizando la etiqueta `<link>` ubicándola entre las etiquetas `<head></head>`, de la siguiente manera:
